      ...
      <div className="flex  md:flex-row md:gap-x-5 md:justify-between ">
        ...
        <div className="w-full relative z-30">
          ...
          <div className="absolute left-14 bottom-40">
            <div className="flex flex-col gap-y-4 py-2 px-4 w-44 backdrop-brightness-[1.3] backdrop-blur-3xl opacity-90 rounded-3xl shadow">
          ...
          <div className="absolute right-20 bottom-52">
            <div className="flex items-center gap-x-4 py-3 px-4 bg-slate-100 bg-opacity-[0.85] rounded-3xl shadow">
              <div className="flex">
